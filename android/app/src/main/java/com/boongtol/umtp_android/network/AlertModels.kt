...
data class AlertItem(
    ...
    val fraud_probability_v1: Double? = null,
    val fraud_probability_label_v1: String? = null,
    val fraud_probability_v1_text: String? = null,
    val fraud_model_version_v1: String? = null,
    val fraud_scored_at_v1: String? = null,
    val fraud_probability_v2: Double? = null,
    val fraud_probability_label_v2: String? = null,
    val fraud_probability_v2_text: String? = null,
    val fraud_model_version_v2: String? = null,
    val fraud_scored_at_v2: String? = null,
    val fraud_probability_v3: Double? = null,
    val fraud_probability_label_v3: String? = null,
    val fraud_probability_v3_text: String? = null,
    val fraud_model_version_v3: String? = null,
    val fraud_scored_at_v3: String? = null,
    val fraud_probability_delta_v2_minus_v1: Double? = null,
    val fraud_probability_delta_v2_minus_v1_text: String? = null,
    val fraud_probability_delta_v3_minus_v2: Double? = null,
    val fraud_probability_delta_v3_minus_v2_text: String? = null,
    val fraud_probability_comparison_text: String? = null,
