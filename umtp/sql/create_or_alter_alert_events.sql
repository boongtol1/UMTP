...
CREATE TABLE IF NOT EXISTS alert_events (
  ...
  fraud_probability_v3 DECIMAL(6,5) NULL,
  fraud_probability_label_v3 VARCHAR(20) NULL,
  fraud_model_version_v3 VARCHAR(100) NULL,
  fraud_scored_at_v3 DATETIME NULL,
