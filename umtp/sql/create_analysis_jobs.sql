...
CREATE TABLE IF NOT EXISTS analysis_jobs (
  ...
  UNIQUE KEY uq_analysis_jobs_user_rule_product (user_id, watch_rule_id, product_id)
...
SET @sql_uq_analysis_user_rule_product = IF(
  ...
  'ALTER TABLE analysis_jobs ADD UNIQUE KEY uq_analysis_jobs_user_rule_product (user_id, watch_rule_id, product_id)',
