    ...
    def test_migration_creates_fraud_store_monitor_tables(self):
        ...
        try:
            ...
            expected_columns = [
                ...
                ("fraud_store_profile_field_snapshots", "store_id"),
                ("fraud_store_profile_field_snapshots", "store_seq"),
                ("fraud_store_profile_field_snapshots", "checked_at"),
                ("fraud_store_profile_field_snapshots", "status"),
                ("fraud_store_profile_field_snapshots", "trust_score"),
                ("fraud_store_profile_field_snapshots", "review_count"),
                ("fraud_store_profile_field_snapshots", "store_level"),
                ("fraud_store_profile_field_snapshots", "store_level_number"),
                ("fraud_store_profile_field_snapshots", "safe_trade_count"),
                ("fraud_store_profile_field_snapshots", "reliability_score"),
                ("fraud_store_profile_field_snapshots", "activity_score"),
                ("fraud_store_profile_field_snapshots", "notified_score"),
                ("fraud_store_profile_field_snapshots", "visit_today_count"),
                ("fraud_store_profile_field_snapshots", "visit_total_count"),
                ("fraud_store_profile_field_snapshots", "is_official_account"),
                ...
                ("fraud_product_snapshots", "product_id"),
                ("fraud_product_snapshots", "store_id"),
                ("fraud_product_snapshots", "observed_at"),
                ("fraud_product_snapshots", "sort_date"),
                ("fraud_product_snapshots", "price_krw"),
                ("fraud_product_snapshots", "title_hash"),
                ("fraud_product_snapshots", "content_hash"),
                ("fraud_product_snapshots", "snapshot_reason"),
                ("fraud_product_snapshots", "raw_payload_json"),
            ...
            expected_indexes = [
                ...
                ("fraud_store_profile_field_snapshots", "idx_store_checked"),
                ("fraud_store_profile_field_snapshots", "idx_status_checked"),
                ("fraud_store_profile_field_snapshots", "idx_store_seq_checked"),
                ...
                ("fraud_product_snapshots", "idx_product_observed"),
                ("fraud_product_snapshots", "idx_store_observed"),
                ("fraud_product_snapshots", "idx_product_sort_date"),
                ("fraud_product_snapshots", "idx_snapshot_reason"),
