...
MIGRATION_SQL_PATH = os.path.join(PROJECT_ROOT, "sql", "migrate_user_push_tokens.sql")
...
class UserPushTokensMigrationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        try:
    ...
    def test_migration_creates_user_push_tokens_table_columns_and_indexes(self):
        connection = get_connection()
        ...
        try:
            ...
            expected_indexes = [
                "uq_user_push_tokens_fcm_token",
                "idx_user_push_tokens_user_active",
            ]
